...
export const experimentalComponents = ["Drawer", "Sidebar", "Toast"];

export const deferredComponents = ["NumberField"];
...
export const componentParts = {
	...
	OTPField: ["OTPFieldCell", "OTPFieldInput"],
	Pagination: [
		"PaginationContent",
		"PaginationEllipsis",
		"PaginationItem",
	...
	Popover: ["PopoverClose", "PopoverDescription", "PopoverPopup", "PopoverTitle", "PopoverTrigger"],
	...
	Toolbar: ["ToolbarButton", "ToolbarGroup", "ToolbarGroupItem", "ToolbarLink", "ToolbarSeparator"],
};
...
export const componentMetadata = Object.freeze({
	...
	Toolbar: {
		...
		tier: "direct primitive",
		foundation: "bits",
		parts: ["ToolbarButton", "ToolbarGroup", "ToolbarGroupItem", "ToolbarLink"],
		particlePriority: "mvp",
		status: "stable",
	},
	Tooltip: {
